...
forward onShowTowedPlayerVeh(playerid);
public onShowTowedPlayerVeh(playerid)
{
    new rows;
    ...
    {
        SendClientMessage(playerid,COLOR_GREY,"Es befindet sich kein Privatfahrzeug in der Verwahrstelle.");
    }
    return 1;
}