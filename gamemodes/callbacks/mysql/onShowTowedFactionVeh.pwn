...
forward onShowTowedFactionVeh(playerid);
public onShowTowedFactionVeh(playerid)
{
    new rows;
    ...
    {
        SendClientMessage(playerid,COLOR_GREY,"Es befindet sich kein Fraktionsfahrzeug in der Verwahrstelle.");
    }
    return 1;
}
